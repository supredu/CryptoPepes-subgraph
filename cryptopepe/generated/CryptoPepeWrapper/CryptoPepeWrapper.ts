...
export class BatchWrap extends ethereum.Event {
  get params(): BatchWrap__Params {
    return new BatchWrap__Params(this);
  }
}

export class BatchWrap__Params {
  _event: BatchWrap;

  constructor(event: BatchWrap) {
    this._event = event;
  }
...
export class Wrap extends ethereum.Event {
  get params(): Wrap__Params {
    return new Wrap__Params(this);
  }
}

export class Wrap__Params {
  _event: Wrap;

  constructor(event: Wrap) {
    this._event = event;
  }
...
export class CryptoPepeWrapper extends ethereum.SmartContract {
  static bind(address: Address): CryptoPepeWrapper {
    return new CryptoPepeWrapper("CryptoPepeWrapper", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get _cryptoPepeAddress(): Address {
...
export class BatchWrapCall extends ethereum.Call {
  get inputs(): BatchWrapCall__Inputs {
    return new BatchWrapCall__Inputs(this);
  }

  get outputs(): BatchWrapCall__Outputs {
    return new BatchWrapCall__Outputs(this);
  }
}

export class BatchWrapCall__Inputs {
  _call: BatchWrapCall;

  constructor(call: BatchWrapCall) {
    this._call = call;
  }
...
export class BatchWrapCall__Outputs {
  _call: BatchWrapCall;
